    ...
    <div className="flex flex-col min-h-screen font-serif">
      ...
      <main className="flex-1 bg-[#F5EFD9] py-12 px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12">
          <h1 className="text-4xl font-bold text-[#2F4F33] mb-4">Privacy Policy</h1>
          <p className="text-[#7D6B58] mb-8">Last updated: October 07, 2025</p>

          <div className="prose prose-lg max-w-none text-[#3A4045]">
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Interpretation and Definitions</h2>

            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Interpretation</h3>
            <p className="mb-6">
              The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>

            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Definitions</h3>
            <p className="mb-4">For the purposes of this Privacy Policy:</p>
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
              <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Haven Ground.</li>
              ...
              <li><strong>Website</strong> refers to Haven Ground, accessible from havenground.com</li>
              <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
            </ul>

            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Collecting and Using Your Personal Data</h2>

            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Types of Data Collected</h3>

            <h4 className="text-lg font-semibold text-[#2F4F33] mt-4 mb-2">Personal Data</h4>
            <p className="mb-4">
            ...
            <h4 className="text-lg font-semibold text-[#2F4F33] mt-4 mb-2">Usage Data</h4>
            ...
            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Tracking Technologies and Cookies</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Use of Your Personal Data</h3>
            ...
            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Retention of Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Transfer of Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Delete Your Personal Data</h3>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Disclosure of Your Personal Data</h2>

            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Business Transactions</h3>
            <p className="mb-6">
              If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </p>

            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Law enforcement</h3>
            <p className="mb-6">
              Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>

            <h3 className="text-xl font-semibold text-[#2F4F33] mt-6 mb-3">Other legal requirements</h3>
            ...
            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Security of Your Personal Data</h2>
            <p className="mb-6">
              The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
            </p>

            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Children's Privacy</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Links to Other Websites</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Changes to this Privacy Policy</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#2F4F33] mt-8 mb-4">Contact Us</h2>
            <p className="mb-4">
              If you have any questions about this Privacy Policy, You can contact us by email: <a href="mailto:support@havenground.com" className="text-[#7D6B58] hover:text-[#2F4F33] underline">support@havenground.com</a>
            </p>
          </div>
        </div>
      </main>
